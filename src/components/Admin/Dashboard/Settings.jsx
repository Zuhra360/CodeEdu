...
export const Settings = () => {
  return (
    <div className='md:w-[calc(100%-290px)] w-[calc(100%-190px)] p-[10px] absolute md:left-[250px] left-[190px] md:h-[600px] h-auto bg-[#EEEEEE] rounded-[10px] flex md:flex-row flex-col gap-[20px]'>
