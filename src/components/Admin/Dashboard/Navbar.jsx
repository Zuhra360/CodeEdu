  ...
  return (
    ...
    <div className='w-11/12 h-[50px] py-[10px] px-[10px] bg-[#EEEEEE] flex items-center flex-row justify-between rounded-[10px]'>
      <div className="h-[20px] w-auto flex items-center flex-row gap-[5px] ">
        <h1 className="  text-bold text-3xl leading-[19px] text-[#1D1616]">CodeEdu</h1>
      ...
      <button onClick={handlebuttonClick}><CgProfile  className="w-[30px] h-[30px] text-[#1D1616] hover:text-[#3E5879]"/></button>
